# UTC 4 — Décisions du comité (réunion du 12/06/2026)

> **Mode d'emploi** : compléter ce document pendant la réunion — cocher `[x]`,
> remplacer les `___`. Laisser vide ce qui n'est pas tranché : rien ne sera
> inventé, les éléments non décidés restent "à confirmer" sur le site.
>
> **En fin de réunion** : lancer Claude Code dans `~/Projects/ladtc` et dire
> « **applique les décisions de docs/utc4-decisions-2026-06-12.md** ».
> → mise à jour du site + tests + push → en ligne sur https://ladtc.be/utc

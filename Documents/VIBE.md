...
- **Docstrings** : style Google en anglais sur les fonctions publiques
- **Texte UI** : français (fichiers de localisation, constantes string)
- **Commits** : anglais, format conventionnel (feat:, fix:, docs:, test:, refactor:)
- **Documentation** : en-têtes français, exemples de code en anglais
...
- Consult HillsRun or RecettesApp VIBE.md for shared patterns
